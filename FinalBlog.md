# Does Falcon3 Know How to Make a Bioweapon? We Ran the Test.
...
*[Figure 2: Log-linear scaling plot — Falcon3 accuracy vs. log₂(parameters), with published WMDP reference lines]*
...
*[Figure 1: Bar chart — all models sorted by accuracy, error bars = 95% CI, Falcon3 models in blue]*
...
*Jawad Haider · June 2026 · [Part 2 — Machine Unlearning on Falcon3 → Coming Soon]()*
